...
public class AdminHomePage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setMaximumSize(new java.awt.Dimension(184, 70));
        jButton1.setMinimumSize(new java.awt.Dimension(184, 70));
        jButton1.setPreferredSize(new java.awt.Dimension(184, 70));
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 20, 200, 50));
        ...
        jButton2.setMaximumSize(new java.awt.Dimension(184, 70));
        jButton2.setMinimumSize(new java.awt.Dimension(184, 70));
        jButton2.setPreferredSize(new java.awt.Dimension(184, 70));
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton2ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 80, 200, 50));
        ...
        jButton3.setMaximumSize(new java.awt.Dimension(184, 70));
        jButton3.setMinimumSize(new java.awt.Dimension(184, 70));
        jButton3.setPreferredSize(new java.awt.Dimension(184, 70));
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton3ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 200, 50));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 200, 200, 50));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 260, 200, 50));
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 380, -1, -1));
